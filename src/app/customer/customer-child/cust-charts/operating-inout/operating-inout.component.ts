...
export class OperatingInoutComponent extends BaseComponent implements OnInit {
    ...
    setData() {
        ...
        // this.import = this.ImportExportDetail.data.body.import;
        // this.export = this.ImportExportDetail.data.body.export;
    ...
    setImportExportDetailData() {
        this.import = this.custchartsService._import
        this.export = this.custchartsService._export

        console.log('yyy', this.custchartsService)
    }
}
